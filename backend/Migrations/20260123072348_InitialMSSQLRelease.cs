...
{
    /// <inheritdoc />
    public partial class InitialMSSQLRelease : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TargetMeetings = table.Column<int>(type: "int", nullable: false),
                    TargetData = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SalesTargets", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SalesTargets_Users_TeamLeaderId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WeeklyWarRooms", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WeeklyWarRooms_Users_CreatedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProjectDepartments", x => new { x.ProjectId, x.DeptId });
                    table.ForeignKey(
                        name: "FK_ProjectDepartments_Departments_DeptId",
                        column: x => x.DeptId,
                        principalTable: "Departments",
                        principalColumn: "DeptId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProjectTeamLeaders", x => new { x.ProjectId, x.UserId });
                    table.ForeignKey(
                        name: "FK_ProjectTeamLeaders_Projects_ProjectId",
                        column: x => x.ProjectId,
                        principalTable: "Projects",
                        principalColumn: "ProjectId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProjectTeamLeaders_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DueDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    SpecificTime = table.Column<TimeSpan>(type: "time", nullable: true),
                    Status = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Priority = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    EstimatedHours = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    DriveFolderLink = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    MaterialDriveFolderLink = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    Tags = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    DelegatedBy = table.Column<int>(type: "int", nullable: true),
                    OriginalAssignerId = table.Column<int>(type: "int", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ...
                    SalesActivityType = table.Column<int>(type: "int", nullable: true),
                    SalesMandatoryNote = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    SalesClientInfo = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    SalesMarketSegmentId = table.Column<int>(type: "int", nullable: true),
                    FinalKpiValue = table.Column<decimal>(type: "decimal(18,2)", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Tasks_MarketSegments_SalesMarketSegmentId",
                        column: x => x.SalesMarketSegmentId,
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Tasks_Users_DelegatedBy",
                        column: x => x.DelegatedBy,
                        principalTable: "Users",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Tasks_Users_OriginalAssignerId",
                        column: x => x.OriginalAssignerId,
                        principalTable: "Users",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WorkTaskTaskId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Attachments", x => x.AttachmentId);
                    table.ForeignKey(
                        name: "FK_Attachments_Tasks_WorkTaskTaskId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "CompanyId");
                    table.ForeignKey(
                        name: "FK_CalendarEvents_Projects_RelatedProjectId",
                        column: x => x.RelatedProjectId,
                        principalTable: "Projects",
                        principalColumn: "ProjectId");
                    table.ForeignKey(
                        name: "FK_CalendarEvents_Tasks_RelatedTaskId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Notifications_Tasks_WorkTaskTaskId",
                        column: x => x.WorkTaskTaskId,
                        principalTable: "Tasks",
                        principalColumn: "TaskId");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Content = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    IsRejectionReason = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Attachments_WorkTaskTaskId",
                table: "Attachments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CalendarEvents_RelatedProjectId",
                table: "CalendarEvents",
                column: "RelatedProjectId");

            migrationBuilder.CreateIndex(
                name: "IX_CalendarEvents_RelatedTaskId",
                table: "CalendarEvents",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MarketSegments_Place_Category",
                table: "MarketSegments",
                columns: new[] { "Place", "Category" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Notifications_WorkTaskTaskId",
                table: "Notifications",
                column: "WorkTaskTaskId");

            migrationBuilder.CreateIndex(
                name: "IX_ProjectDepartments_DeptId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectTeamLeaders_UserId",
                table: "ProjectTeamLeaders",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_SalesTargets_TeamLeaderId",
                table: "SalesTargets",
                column: "TeamLeaderId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tasks_OriginalAssignerId",
                table: "Tasks",
                column: "OriginalAssignerId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tasks_SalesMarketSegmentId",
                table: "Tasks",
                column: "SalesMarketSegmentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WeeklyWarRooms_CreatedByUserId",
                table: "WeeklyWarRooms",
