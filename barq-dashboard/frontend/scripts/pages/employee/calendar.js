...
let teamMembers = []; // Empty for employees
...
async function loadCalendarData() {
  try {
    ...
    // Employees don't need all users list usually
    ...
    // Filter tasks: My Tasks only
    tasks = tasksResponse.filter(
